    ...
    window.addEventListener("storage", () => {
      ...
      if (localStorage.getItem("direction")) {
        ...
        if (showCategories === "true") {
          ...
          if (category !== -1) {
            document.getElementById(`category${category}`).style.border =
              "4px solid #ff772f";
            document.getElementById(`category${category}`).style.borderRadius =
              "3px";
          }
          ...
          let image = document.getElementById(
            `position${positionVertic}-${positionHoriz}`
          );
          image.style.border = "";
      ...
      if (localStorage.getItem("submit")) {
        ...
        if (positionHoriz === 1 && positionVertic === 1) {
          //wird auf den Bestseller geklickt
          ...
          //wird auf das Dropdown Mennue geklickt
          if (showCategories !== null) {
            //ist das Menue sichtbar
            if (category === -1) {
              //handelt es sich um das Dropdown
              document.getElementById("position0-0").click();
              localStorage.removeItem("showCategories");
            } else if (category === 1) {
              //handelt es sich um die Kategorie Romane
        ...
        <CarouselBestseller className="row">
          ...
          <CarouselItemBestsellerMiddle to="/detail" className="col-4">
            <img
              ...
              alt="Bestseller2"
              id="position1-1"
              style={{ border: "4px solid #ff772f", borderRadius: "3px" }}
            />
